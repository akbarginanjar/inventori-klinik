  ...
  <div class="container-fluid justify-content-between">
    ...
    <div class="d-flex align-items-center me-3">
      ...
      <div class="dropdown me-4 position-relative">
        <a class="text-dark nav-link dropdown-toggle" href="#" id="notifDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notifDropdown" style="width: 300px;">
          ...
          <li><a class="dropdown-item" href="/admin/notifikasi/detail">
          <div class="card">
          <div class="p-2" style="font-size: 13px;">
            <span class="position-absolute top-0 start-100 translate-middle p-1 bg-danger border border-light rounded-circle">
              <span class="visually-hidden">New alerts</span>
            </span>
            Stok Obat <b>Paramex</b> sudah <b>20</b> <br>
            <div style="font-size: 11px;">23-03-2025</div>
          </div>  
          </div>  
          </a></li>
          <li><hr class="dropdown-divider"></li>
